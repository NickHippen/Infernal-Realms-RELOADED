...
public class CustomZombiePigman extends EntityPigZombie implements InfernalMob {

	public static final int ENTITY_ID = 57;
	...
	public CustomZombiePigman(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomZombiePigman(World world, CustomMobData customMobData) {
		super(world);
