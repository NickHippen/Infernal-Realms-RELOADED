...
public class CustomWitch extends EntityWitch implements InfernalMob {

	public static final int ENTITY_ID = 66;
	...
	public CustomWitch(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomWitch(World world, CustomMobData customMobData) {
		super(world);
