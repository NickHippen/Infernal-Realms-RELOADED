...
public class CustomWolf extends EntityWolf implements InfernalMob {

	public static final int ENTITY_ID = 95;
	...
	public CustomWolf(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomWolf(World world, CustomMobData customMobData) {
		super(world);
		...
		this.targetSelector.a(5, new PathfinderGoalNearestAttackableTarget<EntityHuman>(this, EntityHuman.class, false));
	}
