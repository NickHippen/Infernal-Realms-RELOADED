...
public class CustomEndermite extends EntityEndermite implements InfernalMob {

	public static final int ENTITY_ID = 67;
	...
	public CustomEndermite(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomEndermite(World world, CustomMobData customMobData) {
		super(world);
