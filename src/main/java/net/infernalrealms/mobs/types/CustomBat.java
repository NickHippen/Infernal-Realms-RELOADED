...
public class CustomBat extends EntityBat implements InfernalMob {

	public static final int ENTITY_ID = 65;
	...
	public CustomBat(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomBat(World world, CustomMobData customMobData) {
		super(world);
