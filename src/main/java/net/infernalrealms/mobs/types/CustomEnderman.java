...
public class CustomEnderman extends EntityEnderman implements InfernalMob {

	public static final int ENTITY_ID = 58;
	...
	public CustomEnderman(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomEnderman(World world, CustomMobData customMobData) {
		super(world);
