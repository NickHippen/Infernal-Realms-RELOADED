...
public class CustomRabbit extends EntityRabbit implements InfernalMob {
	...
	public CustomRabbit(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomRabbit(World world, CustomMobData customMobData) {
		super(world);
