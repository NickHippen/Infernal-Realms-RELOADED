...
public class CustomSilverfish extends EntitySilverfish implements InfernalMob {

	public static final int ENTITY_ID = 60;
	...
	public CustomSilverfish(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomSilverfish(World world, CustomMobData customMobData) {
		super(world);
