...
public class CustomCaveSpider extends EntityCaveSpider implements InfernalMob {

	public static final int ENTITY_ID = 59;
	...
	public CustomCaveSpider(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomCaveSpider(World world, CustomMobData customMobData) {
		super(world);
