...
public class CustomZombie extends EntityZombie implements InfernalMob {

	public static final int ENTITY_ID = 54;
	...
	public CustomZombie(org.bukkit.World world, CustomMobData customMobData, boolean baby) {
		this(((CraftWorld) world).getHandle(), customMobData, baby);
	}

	public CustomZombie(World world, CustomMobData customMobData, boolean baby) {
		super(world);
