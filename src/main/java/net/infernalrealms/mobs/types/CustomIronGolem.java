...
public class CustomIronGolem extends EntityIronGolem implements InfernalMob {

	public static final int ENTITY_ID = 99;
	...
	public CustomIronGolem(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomIronGolem(World world, CustomMobData customMobData) {
		super(world);
