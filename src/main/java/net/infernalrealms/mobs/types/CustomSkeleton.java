...
public class CustomSkeleton extends EntitySkeleton implements InfernalMob {

	public static final int ENTITY_ID = 51;
	...
	//		super(world);
	//		this.fireProof = true;
	//		System.out.println("On creation called through BAD constructor. Entity ID is " + this.getId());
	//		System.out.println("Location is " + getBukkitEntity().getLocation());
	...
	public CustomSkeleton(org.bukkit.World world, CustomMobData customMobData, boolean wither) {
		this(((CraftWorld) world).getHandle(), customMobData, wither);
	}

	public CustomSkeleton(World world, CustomMobData customMobData, boolean wither) {
		super(world);
