...
public class CustomBlaze extends EntityBlaze implements InfernalMob {

	public static final int ENTITY_ID = 61;
	...
	public CustomBlaze(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomBlaze(World world, CustomMobData customMobData) {
		super(world);
