...
public class CustomGuardian extends EntityGuardian implements InfernalMob {

	public static final int ENTITY_ID = 68;
	...
	public CustomGuardian(org.bukkit.World world, CustomMobData customMobData) {
		this(((CraftWorld) world).getHandle(), customMobData);
	}

	public CustomGuardian(World world, CustomMobData customMobData) {
		super(world);
