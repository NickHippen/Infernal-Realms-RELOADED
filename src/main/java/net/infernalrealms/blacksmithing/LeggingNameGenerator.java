...
public final class LeggingNameGenerator {
	...
	private static final String[] nm5 = new String[] { "Legguards", "Platelegs", "Legplates", "Greaves", "Skirt", "Leggings", "Kilt" };
	private static final String[] nm5_2 = new String[] { "Legwraps", "Legguards", "Kilt", "Skirt", "Pants", "Robes", "Breeches", "Leggings",
			"Britches" };
	private static final String[] nm6 = new String[] { "Armament", "Scales", "Guard", "Bastion", "Steel", "Defense", "Bane", "Bond", "Boon",
			...
			"Terror", "Token", "Tribute", "Vengeance", "Vindicator", "Visage", "Voice", "Ward", "Warden", "Whisper", "Wit", "Armor",
	...
	private static final String[] nm6_2 = new String[] { "Armament", "Bane", "Bond", "Boon", "Call", "Champion", "Conqueror", "Crusader",
			...
			"Vengeance", "Vindicator", "Visage", "Voice", "Ward", "Warden", "Whisper", "Wit", "Legwraps", "Legguards", "Kilt", "Skirt",
			"Pants", "Robes", "Breeches", "Leggings", "Britches" };
	...
	public static String generateName(boolean heavy) {
		...
		String[] nm6;
		if (heavy) {
			nm4 = LeggingNameGenerator.nm4;
			nm5 = LeggingNameGenerator.nm5;
			nm6 = LeggingNameGenerator.nm6;
		} else {
			nm4 = nm4_2;
			nm5 = nm5_2;
			nm6 = nm6_2;
